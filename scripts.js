...
const botaoPublucar = document.querySelector(".botao-publicar");
...
botaoPublucar.addEventListener("click", async (evento) => {
    evento.preventDefault();
...
botaoDescartar = document.querySelector(".botao-descartar");
